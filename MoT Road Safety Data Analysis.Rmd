...
cas.data <- read.csv("../Data/Crash_Analysis_System_(CAS)_data.csv")
...
barplot(cas.data$seriousInjuryCount)
...
journey.to.work$same.area.boolean <- journey.to.work["ï..SA2_code_usual_residence_address"] == journey.to.work["SA2_code_workplace_address"]
...
df <- journey.to.work %>% 
  left_join(sa2.centroid.inside[c("SA22018_V1_00", "LATITUDE", "LONGITUDE")], by = c("ï..SA2_code_usual_residence_address" = "SA22018_V1_00")) %>% 
...
hist(df2[df2$dist > 0, ]$dist, breaks=100000)
...
barplot(table(journey.to.work.d["ï..SA2_code_usual_residence_address"] == journey.to.work.d["SA2_code_workplace_address"]))
