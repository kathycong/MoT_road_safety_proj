...
Auckland Traffic Counter data is available in Aucklant Transport data. The data contains traffic from x year.
...
get_risk(st_coordinates(cas_data_akl_2018_proj)[, "X"], 
         st_coordinates(cas_data_akl_2018_proj)[, "Y"], 
         cas_data_akl_2018_proj$seriousInjuryCount + cas_data_akl_2018_proj$fatalCount,
         akl_dist_travel)

cbind(cas_data_akl_proj, cas_data_akl_proj$seriousInjuryCount)
...
risk_proj$ksi_bkm <- as.numeric(risk_proj$risk * 1000000000000)
