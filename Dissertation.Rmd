...
```{r}
mapview(jtw_driving_akl_with_routes[1:20, ], layer.name = "Auckland Driving Commutes")
...
Exposure is defined as the distance travelled by the commuter. It will vary depending on the type of commute.

The distance travelled will enable us to calculate the exposure of 
